  ...
  if (pho.length !=10) {
    ...
    cell5.innerHTML = date.toLocaleTimeString();//toLocaleTimeString()  automatically converts the ouput of new Date() into Local time String.
    ...
    let remover=document.createElement('input'); //to a create a button that removes the row it resides in
        ...
        function createReceiptTable(){        
          ...
          <p><i class="bi bi-cash"></i> Total Due In Rs. :  &ensp;${totaldue}</p>
          <br>
